...
All four padding settings are unconditional; the mobile pair is its own value,
not a multiple of the desktop one (ruled 2026-09-17, see `sections.md`).
`color_scheme` may be omitted only with a Liquid comment explaining why, per
`sections.md`.
