...
Blocks render in the editor and storefront when they are referenced in [template files](templates.md).
...
See [schemas.md](schemas.md) for rules on schemas
...
See [css-standards.md](css-standards.md) for rules on writing CSS
