      ...
      '/assets/': [
        {
          ...
          items: [
            ...
            { text: 'Collection Section', link: '/assets/section-collection' },
            { text: 'Component Filters Price Range', link: '/assets/component-filters-price-range' },
            { text: 'Component Infinite Scroll', link: '/assets/component-infinite-scroll' },
            { text: 'Component Localization Form', link: '/assets/component-localization-form' },
            { text: 'Component Modal Opener', link: '/assets/component-modal-opener' },
            { text: 'Component Pickup Availability', link: '/assets/component-pickup-availability' },
            { text: 'Component Predictive Search', link: '/assets/component-predictive-search' },
            { text: 'Component Product Media Magnify', link: '/assets/component-product-media-magnify' },
            { text: 'Component Product Media Modal', link: '/assets/component-product-media-modal' },
            { text: 'Component Product Share Button', link: '/assets/component-product-share-button' },
            { text: 'Component Quick Add', link: '/assets/component-quick-add' },
            { text: 'Component Selling Plans', link: '/assets/component-selling-plans' },
            { text: 'Customer', link: '/assets/customer' },
            { text: 'Product Recommendations', link: '/assets/product-recommendations' },
            { text: 'Section Featured Products', link: '/assets/section-featured-products' },
            { text: 'Section Product', link: '/assets/section-product' },
