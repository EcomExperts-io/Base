...
Long-form JavaScript patterns and worked examples extracted from
`.cursor/rules/javascript-standards.mdc`. The slim rule keeps the non-negotiable principles;
this file holds the full code examples. Load it with the Read tool when you need depth.
